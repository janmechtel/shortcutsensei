...
const gmailShortcuts: Shortcut[] = [
	...
	// )
	new Shortcut("C", "Compose", "Compose","Compose an email"),
	...
	new Shortcut("Shift+I", "Mark as read", "Read", "bAO T-I-J3 J-J5-Ji"),
	new Shortcut("Shift+U", "Mark as unread", "Unread", "bAP T-I-J3 J-J5-Ji"),
